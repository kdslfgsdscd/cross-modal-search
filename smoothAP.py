...
# import json
# data_dir = 'data/new_feature/pascal_feature'
# id_train = io.loadmat(data_dir + '/img_train_id.mat')['name'].tolist()
# id_test = io.loadmat(data_dir + '/img_test_id.mat')['name'].tolist()
# data_dir = '/home/xutianyuan/papers/cnn-text-classification-pytorch/data/'
# all_list=json.load((open(data_dir+'sentence_label_data.txt')))
# train_list=json.load((open(data_dir+'sentence_label_train.txt')))
# test_list=json.load((open(data_dir+'sentence_label_test.txt')))
# text_train=set([item['text'] for item in all_list if item['id'] in id_train])
# text_test=set([item['text'] for item in all_list if item['id'] in id_test])
# train_list1=set([item['text'] for item in train_list])
# test_list1=set([item['text'] for item in test_list])
#
#
# pass
