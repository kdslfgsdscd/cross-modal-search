...
def get_loader(path, batch_size):
    img_train = loadmat(path + "train_img.mat")['name']
    img_test = loadmat(path + "test_img.mat")['name']
    text_train = loadmat(path + "train_txt.mat")['name']
    text_test = loadmat(path + "test_txt.mat")['name']
    label_train = loadmat(path + "train_label.mat")['name']
    label_test = loadmat(path + "test_label.mat")['name']
    ...
    return dataloader, input_data_par, loadmat(path + "test_img.mat")['name'], loadmat(path + "test_txt.mat")['name'],loadmat(path + "test_label.mat")['name']
